...
public class AnimatedGameObject extends GameObject {
    ...
    private static final Animation.PlayMode MODE = Animation.PlayMode.LOOP;
    ...
    public AnimatedGameObject(Texture tileSheet, int tileWidth, int tileHeight, float x, float y) {
        super(tileSheet, x, y);
